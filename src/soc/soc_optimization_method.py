...
from utils.paths import make_dir_path, get_som_dir_path, get_time_in_hms
from utils.numeric import slice_1d_array
from utils.figures import COLORS_FIG, TITLES_FIG, LABELS_FIG
